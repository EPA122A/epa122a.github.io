...
- A detailed guide on the basic statistical tests [Document](https://www.statstutor.ac.uk/resources/uploaded/tutorsquickguidetostatistics.pdf). NB: This will not be included in the exam. 

***

(L13)=
## Lecture 13 - Theo’s Case Study

**Slides**  

- Lecture slides [PDF](https://surfdrive.surf.nl/s/QLBYkSSrD3bDfpA)
